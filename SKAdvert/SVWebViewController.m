...
- (void)viewDidLoad {
	...
	if(!deviceIsTablet) {
		...
		if(self.navigationController == nil) {
            ...
            UIBarButtonItem *doneButton = [[UIBarButtonItem alloc] initWithTitle:@"close" style:UIBarButtonItemStylePlain target:self action:@selector(dismissController)];
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex {
	...
	if([[actionSheet buttonTitleAtIndex:buttonIndex] isEqualToString:NSLocalizedString(@"Open in Safari", @"SVWebViewController")])
		...
		[emailComposer.navigationBar setTintColor:[UIColor blackColor]];
